...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($link=="" && $filename!="")
        {
            ...
            $size = $_FILES['myfile']['size'];
                ...
                if (move_uploaded_file($file, $destination)) 
                {
                    ...
                    $disp = $_POST['disp'];
                    $ins='INSERT INTO whatnew(name,url,des,pos) values("'.$disp.'","'.$url.'","'.$des.'","'.$cpos.'");';
        ...
        { 
                    $disp = $_POST['disp'];
                    $ins='INSERT INTO whatnew(name,url,des,pos) values("'.$disp.'","'.$link.'","'.$des.'","'.$cpos.'");';
                    if(mysqli_query($sql,$ins)) 
                    {
                        $_SESSION['msg'] = 'success';
                    }   
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>Whats New Notices</a>
          </li>
        </ol>
    <form method="POST" action="whatsnew.php" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Add Description</label>
            <div class="col-sm-10">
    ...
    <div class="table-responsive">
     <table class="table pagin-table" width="100%">
                ...
                <tbody class="row_position">
                   <?php
                            include('../asset/conn.php');
                            $query="SELECT * From whatnew ORDER BY pos;";
                    ...
                    ?>
                                    <tr id="<?php echo $row['id'] ?>">  
                                        ...
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deletewhatsnew.php?id=<?php echo $row['id'];?>">X</a></td>  
                                   <script>
...
foreach($position as $k=>$v){
    $sq = "Update whatnew SET pos=".$i." WHERE id=".$v;
