        ...
        $size = $_FILES['myfile']['size'];
            ...
            else 
            {
                if (move_uploaded_file($file, $destination)) 
                {
                    ...
                    $link = $_POST['link'];
                    $posi="SELECT * FROM govlink;";
                    $qposi_e=mysqli_query($sql,$posi);
                    $qposi=mysqli_num_rows($qposi_e);
                    $cpos=$qposi+1;
                    $ins="INSERT INTO govlink(link,url,pos) values('$link','$url','$cpos');";
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>Add scrolling Gov Images/Links</a>
          </li>
        </ol>
    <form method="POST" action="govlinks.php" enctype="multipart/form-data">


        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Link</label>
            <div class="col-sm-10">
              <input type="text" name="link" class="form-control"  placeholder="http://website.com">
            </div>
        </div>
    ...
    <div class="table-responsive">
     <table class="table pagin-table" width="100%">
                ...
                <tbody class="row_position">
                   <?php
                            include('../asset/conn.php');
                            $query="SELECT * From govlink ORDER by pos;";
                    ...
                    ?>
                                    <tr id="<?php echo $row["id"]; ?>">  
                                        ...
                                        <td><a class="btn btn-primary" href="editgovlinks.php?id=<?php echo $row['id'];?>">Edit</a></td>
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deletegovlinks.php?id=<?php echo $row['id'];?>">X</a></td>  
                                   <script>
...
foreach($position as $k=>$v){
    $sq = "Update govlink SET pos=".$i." WHERE id=".$v;
