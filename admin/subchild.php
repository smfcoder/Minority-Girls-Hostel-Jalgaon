...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql_u = "SELECT * FROM subchild where slug='$slug'";
        ...
        else
        {
                ...
                $ins="INSERT INTO subchild(name,type,slug,p_slug) values('$name','$pwith','$slug','$pslug');";
...
<?php
    ...
    if(isset($_SESSION['msg'])) {
        if($_SESSION['msg']=='success')   {
            ...
            echo '<script>alert("Subchild Page Already registered")</script>';
            unset($_SESSION['msg']);
        }
        else {
...
?> 
  ...
  ?>
    ...
    <form method="POST" action="subchild.php">


        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Sub-Menu Name</label>
            <div class="col-sm-10">
              <input type="text" name="name" class="form-control"  placeholder="Sub Child Name" required>
            </div>
        </div>
         <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Sub-Menu Page Type </label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
               <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onchange="uniqueUser()" name="pslug" required>
                   <option value="">Choose...</option>
                <?php
