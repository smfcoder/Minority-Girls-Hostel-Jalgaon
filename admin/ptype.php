        ...
        else
        {
            if($pwith=="nochild")
            {
                ...
                if(mysqli_query($sql,$ins)) 
                {
                    ...
                    header("location:/admin/parentpage.php");
                }   
                else
                {
                    $_SESSION['msg'] = 'failed';
...
<body id="page-top">
  ...
  ?>
    ...
    <form method="POST" action="ptype.php">

        <input name="name" value="<?php echo $pname;?>" hidden>
        <input name="pwith" value="<?php echo $pw;?>" hidden>
         <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Parent Page Type </label>
            <div class="col-sm-10">
