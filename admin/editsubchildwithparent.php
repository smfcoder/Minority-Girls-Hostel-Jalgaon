...
<?php
    ...
    if(isset($_SESSION['msg'])) {
        if($_SESSION['msg']=='success')   {
            ...
            unset($_SESSION['msg']);
            header("location:/admin/showsubchild.php");
        }
        else {
...
?> 
  ...
  ?>
    ...
    <form method="POST" action="editsubchildwithparent.php">
    <?php
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
               <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onchange="uniqueUser()" name="pslug" required>
                   <option value="<?php echo $qlrow["p_slug"]; ?>"><?php echo $qlrow["p_slug"]; ?></option>
                <?php
