...
<?php
    ...
    {
        $slug = $_POST['slug'];
        $q="DELETE FROM content WHERE slug='$slug';";
        if($e=mysqli_query($sql,$q))
        {
...
<?php
    ...
    if(isset($_SESSION['msg'])) {
        if($_SESSION['msg']=='success')   {
            ...
            echo '<script>alert("Sorry :( Failed Delete)")</script>';
            unset($_SESSION['msg']);
        }
    }
?> 
  ...
  ?>
    ...
    <form method="POST" action="delselecttext.php">


        
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Select to Delete content</label>
            <div class="col-sm-10">
