...
<?php
    ...
    {
        $slug = $_POST['slug'];
        header('location:/admin/addtext.php?slug='.$slug);
    }
?>
<!DOCTYPE html>
<html lang="en">
...
?> 
  ...
  ?>
    ...
    <form method="POST" action="selectortext.php">


        
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Select to add content</label>
            <div class="col-sm-10">
